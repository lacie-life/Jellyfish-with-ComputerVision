...
bool StereoCalib::leftCameraCalibrate(void) {
    ...
    while (!m_leftImagesFilestream.eof()) {
        ...
        if (found) {
            ...
            cv::imshow("Display Image Left", grayImage);
            cv::waitKey(0);
...
bool StereoCalib::rightCameraCalibrate(void) {
    ...
    while (!m_rightImagesFilestream.eof()) {
        ...
        if (found) {
            ...
            cv::imshow("Display Image Right", grayImage);
            cv::waitKey(0);
...
bool StereoCalib::stereoCalibrateAndRectify(void) {
    ...
    std::cout << "king" << "\n";
    std::cout << m_imagePointsLeft.size() << "   " << m_imagePointsRight.size() << "\n";
...
void StereoCalib::getIntrinsicCoeffsLeft()
{
    std::cout << m_intrinsicCoeffsLeft << std::endl;
}

void StereoCalib::getIntrinsicCoeffsRight()
{
    std::cout << m_intrinsicCoeffsRight << std::endl;
}

void StereoCalib::getDistortionCoeffsLeft()
{
    std::cout << m_distortionCoeffsLeft << std::endl;
}

void StereoCalib::getDistortionCoeffsRight()
{
    std::cout << m_distortionCoeffsRight << std::endl;
}
